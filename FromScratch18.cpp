...
///////////////////////////////////////////////////////////////////////////////////////////////////
int main() {
	bool useStillImage = true;			// set this to false to use a webcam
	...
	if (useStillImage == true) {
		...
		long begTickCount = cv::getTickCount();				// begin timing
		...
		long endTickCount = cv::getTickCount();				// end timing
